...
const DigitalAudit: React.FC = () => {
  const { lang } = useLanguage();
  const content = pageContent.digitalAudit[lang];
  ...
  return (
    <div className="min-h-screen">
      ...
      <PageHero
        ...
        backgroundImage="/images/digital-audit-hero.jpg"
        height="md"
        overlay="medium"
      />
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <section className="mb-16">
            <h2 className="text-4xl font-bold text-cyber-emerald dark:text-white mb-8">
              {content.digitalServices.title}
            </h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {content.digitalServices.services.map((service, idx) => (
          ...
          <section className="p-8 bg-white dark:bg-gray-800 rounded-lg border border-cyber-emerald/20">
            <h2 className="text-3xl font-bold text-cyber-emerald dark:text-white mb-4">
              {content.technologyExpertise.title}
            </h2>
            <p className="text-gray-700 dark:text-gray-300 text-lg leading-relaxed">
              {content.technologyExpertise.description}
            </p>
          </section>
        </div>
      </div>
